    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אמיר מוטורס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3a392b6a-df43-4cc9-90b6-843d0f5f86c9',
                    name: data.name || '',
                    email: data.email || '',
